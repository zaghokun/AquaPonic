/**
 * esp-03 — ESP32-S3 -> Cloudflare Worker -> Supabase  (pH via ADS1115)
 *
...
const char* DEVICE_ID = "esp-03";         // identitas unik (BEDA tiap unit)

// --- Konstanta kalibrasi pH (lihat kalibrasi_log.md) ---
const float PH_SLOPE  = -6.525;  // m
const float PH_OFFSET = 24.035;  // b
