/**
 * esp-02 — ESP32-S3 -> Cloudflare Worker -> Supabase  (pH via ADS1115)
 *
...
const char* DEVICE_ID = "esp-02";         // identitas unik (BEDA tiap unit)

// --- Konstanta kalibrasi pH (lihat kalibrasi_log.md) ---
const float PH_SLOPE  = -6.811;  // m
const float PH_OFFSET = 25.383;  // b
