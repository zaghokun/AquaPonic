/**
 * esp-04 — ESP32-S3 -> Cloudflare Worker -> Supabase  (pH via ADS1115)
 *
...
const char* DEVICE_ID = "esp-04";         // identitas unik (BEDA tiap unit)

// --- Konstanta kalibrasi pH (lihat kalibrasi_log.md) ---
const float PH_SLOPE  = -7.051;  // m
const float PH_OFFSET = 25.482;  // b
